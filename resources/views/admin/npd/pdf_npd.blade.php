...
<body>
    <table width="100%" style="font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:11px;border-collapse:collapse">
        <tr>
            <td style="text-align: center;border:1px solid black;padding:3px" colspan="4"><b>NOTA PENCAIRAN DANA
                    (NPD)</b><br />
                NOMOR : {{$data->nomor}}
            </td>
        </tr>
        ...
        <tr>
            <td colspan="4" style="border-left:1px solid black; padding-left:3px;border-right:1px solid black;">Supaya
                mencairkan dana kepada :</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Program</td>
            <td>:</td>
            <td style="border-right:1px solid black;">{{$data->program == null ? '': $data->program->kode. ' - '
                .$data->program->nama}}</td>
        </tr>
        <tr>
            <td style="border-left:1px solid black; padding-left:3px;">3.</td>
            <td>Kegiatan</td>
            <td>:</td>
            <td style="border-right:1px solid black;">{{$data->kegiatan == null ? '': $data->kegiatan->kode. ' - '
                .$data->kegiatan->nama}}</td>
        </tr>
        <tr>
            <td style="border-left:1px solid black; padding-left:3px;">4.</td>
            <td>Subkegiatan</td>
            <td>:</td>
            <td style="border-right:1px solid black;">{{$data->subkegiatan == null ? '': $data->subkegiatan->kode. ' - '
                .$data->subkegiatan->nama}}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Terbilang</td>
            <td>:</td>
            <td style="border-right:1px solid black;">{{terbilang($data->detail->sum('pencairan_saat_ini'))}} Rupiah
            </td>
        </tr>
        <tr>
            <td colspan="4"
                style="border-left:1px solid black;border-right:1px solid black; padding-left:3px;text-align:center">
                <br /><b>PEMBEBANAN PADA KODE REKENING :</b>
            </td>
        </tr>
    </table>
    <table width="100%"
        style="border-collapse:collapse;font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:11px;border:1px solid black;">
        ...
        <tr>
            ...
            <td style="text-align: right;border:1px solid black;padding:3px">Rp., </td>
            <td style="text-align: right;border:1px solid black;padding:3px">
                {{number_format($data->detail->sum('pencairan_saat_ini')-$data->potongan)}}</td>
            <td style="text-align: right;border:1px solid black;padding:3px"></td>
        </tr>
        <tr>
            <td colspan=4 style="text-align: right;border:1px solid black;padding:3px">Terbilang</td>

            <td colspan=3 style="text-align: right;border:1px solid black;padding:3px">
                {{terbilang($data->detail->sum('pencairan_saat_ini') - $data->potongan)}} Rupiah</td>
