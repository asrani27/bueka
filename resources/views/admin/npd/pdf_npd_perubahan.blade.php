...
<body>
    ...
    <table width="100%" style="border-collapse:collapse;font-family:Verdana, Geneva, Tahoma, sans-serif;font-size:11px;border:1px solid black;">
        ...
        <tr class="text-bold">
            ...
            <td style="text-align: right;border:1px solid black;padding:3px">{{number_format($item->rincian->sum('anggaran_perubahan'))}}</td>
            ...
            <td style="text-align: right;border:1px solid black;padding:3px">{{number_format($item->rincian->sum('anggaran_perubahan') - $item->akumulasi - $item->pencairan_saat_ini)}}</td>
        </tr>
        @endforeach
        <tr class="text-bold" style="font-weight: bold">
            ...
            <td style="text-align: right;border:1px solid black;padding:3px">{{number_format($data->detail->flatMap->rincian->sum('anggaran_perubahan'))}}</td>
            ...
            <td style="text-align: right;border:1px solid black;padding:3px">{{number_format($data->detail->flatMap->rincian->sum('anggaran_perubahan') - $data->detail->sum('akumulasi') - $data->detail->sum('pencairan_saat_ini'))}}</td>
        </tr>
        <tr>
