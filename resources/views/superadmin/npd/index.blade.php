    ...
    <div class="col-xs-12">
      <div class="box box-success">
        <div class="box-header">
          ...
          <div class="box-tools">
            <a href="/superadmin/npd/create" class="btn btn-sm btn-success "><i class="fa fa-plus-circle"></i>
              Tambah</a>
          </div>
        </div>
        <!-- /.box-header -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="/superadmin/npd/delete/{{$item->id}}" onclick="return confirm('Yakin ingin di hapus');"
