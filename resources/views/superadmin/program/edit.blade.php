   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <form class="form-horizontal" action="/superadmin/program/edit/{{$data->id}}" method="post">
                @csrf
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <a href="/superadmin/program" class="btn bg-gray btn-block"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                  </div>
              </div>
            </form>
